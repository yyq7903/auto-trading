...
路径: `/home/yyq/workspace/btc5m-trader/.env`
```
...
2. 启动 WebUI（WSL，可选）
   cd /home/yyq/workspace/btc5m-webui && python3 api_server.py &
   打开: http://localhost:8877

3. 启动策略监控（WSL）
   cd /home/yyq/workspace/btc5m-trader
...
# 最新成交
tail -3 /mnt/c/Users/yyq/Desktop/polymarket项目/btc5m数据/trades.jsonl
...
```
/home/yyq/workspace/btc5m-trader/           → 策略代码
...
/home/yyq/workspace/btc5m-webui/              → WebUI
```
